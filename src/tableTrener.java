...
public class tableTrener extends AbstractTableModel {

	ArrayList<Trener> lista;

	public tableTrener(ArrayList<Trener> lista) {
		this.lista = lista;
	}
